...
public class Scores extends JPanel implements JPanelController {
	...
	public JPanel createPanel() {
		...
		pn.add(createMainPanel(11, 4), BorderLayout.CENTER);
	...
	public JPanel createMainPanel(int row, int column) {
		...
		pn.add(new JLabel(new ImageIcon("resources/pictures/background/scores.png")));
		pn.add(new JLabel(new ImageIcon("resources/pictures/background/scores.png")));
		pn.add(new JLabel(new ImageIcon("resources/pictures/background/timer.png")));
		pn.add(player);
